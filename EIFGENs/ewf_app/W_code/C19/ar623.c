...
extern void F623_4552(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F623_4553(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F623_4554(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F623_4555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F623_4556(EIF_REFERENCE);
...
void F623_4552 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 622, Current, 0, 1, 7882);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7882);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ub1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3646, dtype))(Current, ub1x);
	RTHOOK(3);
...
/* {ARRAYED_STACK}.put */
void F623_4553 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 622, Current, 0, 1, 7883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7883);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {ARRAYED_STACK}.force */
void F623_4554 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 622, Current, 0, 1, 7884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7884);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
void F623_4555 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 622, Current, 0, 0, 7885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7885);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F623_4556 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 622, Current, 1, 0, 7886);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(622, Current, 7886);
	RTIV(Current, RTAL);
	RTHOOK(1);
