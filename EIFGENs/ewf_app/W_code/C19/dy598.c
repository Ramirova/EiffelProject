...
extern void F598_4402(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F598_4404(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F598_4405(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F598_4409(EIF_REFERENCE);
...
void F598_4402 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 597, Current, 1, 1, 6918);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(597, Current, 6918);
	RTIV(Current, RTAL);
...
void F598_4404 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 597, Current, 0, 1, 6919);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(597, Current, 6919);
	RTCC(arg1, 597, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
body:;
	...
	for (;;) {
		...
		ub1 = tb2;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3603, dtype))(Current, ub1x);
		RTHOOK(8);
...
void F598_4405 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 597, Current, 0, 1, 6920);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(597, Current, 6920);
	RTCC(arg1, 597, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F598_4409 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 597, Current, 0, 0, 6921);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(597, Current, 6921);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
