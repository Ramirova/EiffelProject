...
extern void F622_2163(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F622_2164(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F622_2163 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 621, Current, 0, 1, 2559);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(621, Current, 2559);
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F622_2164 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 621, Current, 1, 1, 2560);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(621, Current, 2560);
	{
...
body:;
	RTHOOK(3);
	RTDBGAL(Current, 1, 0xF800026E, 0, 0); /* loc1 */
	{
	...
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(6);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1820, "item", arg1))(arg1)).it_b);
		ub1 = tb2;
	...
	for (;;) {
		...
		if (!tb3) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1850, dtype))(Current)).it_b);
			tb2 = (EIF_BOOLEAN) !tb3;
		}
		if (tb2) break;
		RTHOOK(9);
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1867, "item", loc1))(loc1)).it_b);
		ub1 = tb3;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1854, dtype))(Current, ub1x);
		RTHOOK(10);
