...
extern EIF_TYPED_VALUE F608_4398(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F608_4399(EIF_REFERENCE);
extern EIF_TYPED_VALUE F608_4400(EIF_REFERENCE);
extern void F608_7416(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F608_4398 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 607, Current, 2, 1, 6871);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(607, Current, 6871);
	RTCC(arg1, 607, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
...
/* {LIST}.after */
EIF_TYPED_VALUE F608_4399 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 607, Current, 0, 0, 6872);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(607, Current, 6872);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F608_4400 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 607, Current, 0, 0, 6873);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(607, Current, 6873);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F608_7416 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 607, Current, 0, 7415);
	RTSA(dtype);
	RTME(dtype, 0);
