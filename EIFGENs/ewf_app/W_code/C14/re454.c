...
extern EIF_TYPED_VALUE F454_4115(EIF_REFERENCE);
extern EIF_TYPED_VALUE F454_4118(EIF_REFERENCE);
extern void F454_7411(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F454_4115 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 453, Current, 0, 0, 5236);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(453, Current, 5236);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F454_4118 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 453, Current, 0, 0, 5237);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(453, Current, 5237);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) (ti4_1 <= ti4_2)) {
			...
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3422, dtype))(Current)).it_i4);
...
void F454_7411 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 453, Current, 0, 7410);
	RTSA(dtype);
	RTME(dtype, 0);
