...
extern void F444_2173(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F444_2174(EIF_REFERENCE);
extern EIF_TYPED_VALUE F444_2175(EIF_REFERENCE);
extern EIF_TYPED_VALUE F444_2176(EIF_REFERENCE);
extern void F444_7389(EIF_REFERENCE, int);
...
void F444_2173 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_b
	...
	RTEAA(l_feature_name, 443, Current, 0, 3, 2645);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(443, Current, 2645);
	RTCC(arg1, 443, l_feature_name, 1, RTWCT(1890, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1890, 0xF80001B9, 0); /* active */
	RTAR(Current, arg1);
...
EIF_TYPED_VALUE F444_2174 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F444_2175 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F444_2176 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F444_7389 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 443, Current, 0, 7388);
	RTSA(dtype);
	RTME(dtype, 0);
