/*
 * Code for class HTTPD_REQUEST_HANDLER
 */
...
extern void F172_2270(EIF_REFERENCE);
...
/* {HTTPD_REQUEST_HANDLER}.release */
void F172_2270 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 171, Current, 2, 0, 2745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(171, Current, 2745);
	RTIV(Current, RTAL);
	if (
		WDBG(171,"dbglog")
	) {
		...
		loc2 = RTCCL(tr1);
		if (EIF_TEST(loc2)) {
			tb2 = *(EIF_BOOLEAN *)(loc2 + RTVA(2530, "descriptor_available", loc2));
			tb1 = tb2;
		}
		if (tb1) {
			RTHOOK(2);
			RTDBGAL(Current, 1, 0xF800012F, 0, 0); /* loc1 */
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2069, "descriptor", loc2))(loc2)).it_i4);
			RTNHOOK(2,1);
			tr1 = c_outi(ti4_1);
	...
	RTHOOK(5);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(1973, 170))(Current);
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(563, dtype))(Current);
	if (
		WDBG(171,"dbglog")
	) {
		RTHOOK(7);
		if ((EIF_BOOLEAN)(loc1 != NULL)) {
			...
			RTHOOK(9);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			tr2 = RTMS_EX_H(".release: LEAVE {N/A}",21,1873726589);
			ur1 = tr2;
			tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4840, "plus", tr1))(tr1, ur1x)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr2);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1904, dtype))(Current, ur1x);
