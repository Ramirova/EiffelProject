...
extern EIF_TYPED_VALUE F406_4384(EIF_REFERENCE);
extern EIF_TYPED_VALUE F406_4385(EIF_REFERENCE);
extern void F406_4391(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F406_4394(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F406_4395(EIF_REFERENCE);
extern EIF_TYPED_VALUE F406_4396(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F406_4384 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 405, Current, 0, 0, 6784);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(405, Current, 6784);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F406_4385 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 405, Current, 0, 0, 6785);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(405, Current, 6785);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F406_4391 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 405, Current, 0, 1, 6786);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(405, Current, 6786);
	RTCC(arg1, 405, l_feature_name, 1, RTWCT(1867, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F406_4394 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 405, Current, 0, 1, 6787);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(405, Current, 6787);
	RTCC(arg1, 405, l_feature_name, 1, RTWCT(1867, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F406_4395 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 405, Current, 0, 0, 6788);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(405, Current, 6788);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F406_4396 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 405, Current, 2, 1, 6789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(405, Current, 6789);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
