...
extern EIF_TYPED_VALUE F246_4773(EIF_REFERENCE);
...
EIF_TYPED_VALUE F246_4773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 245, Current, 0, 0, 8096);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(245, Current, 8096);
	RTIV(Current, RTAL);
	RTHOOK(1);
