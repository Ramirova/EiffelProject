...
extern EIF_TYPED_VALUE F900_4115(EIF_REFERENCE);
extern EIF_TYPED_VALUE F900_4118(EIF_REFERENCE);
extern void F900_7411(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F900_4115 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 899, Current, 0, 0, 5263);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F900_4118 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 899, Current, 0, 0, 5264);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F900_7411 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 899, Current, 0, 7410);
	RTSA(dtype);
	RTME(dtype, 0);
