...
extern EIF_TYPED_VALUE F143_1852(EIF_REFERENCE);
...
EIF_TYPED_VALUE F143_1851 (EIF_REFERENCE Current)
{
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1094, 71))(Current)).it_i4);
...
RTOID (F143_1852)
EIF_TYPED_VALUE F143_1852 (EIF_REFERENCE Current)
{
	GTCX
