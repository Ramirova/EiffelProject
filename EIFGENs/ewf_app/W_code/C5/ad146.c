...
extern EIF_TYPED_VALUE F146_1855(EIF_REFERENCE);
extern EIF_TYPED_VALUE F146_1856(EIF_REFERENCE);
...
EIF_TYPED_VALUE F146_1855 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 145, Current, 0, 0, 1826);
	RTSA(Dtype(Current));
	RTSC;
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1101, 71))(Current)).it_i4);
...
RTOID (F146_1856)
EIF_TYPED_VALUE F146_1856 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 145, Current, 0, 0, 1827);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
