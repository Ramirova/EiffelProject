...
extern EIF_TYPED_VALUE F28_551(EIF_REFERENCE);
extern EIF_TYPED_VALUE F28_552(EIF_REFERENCE);
extern EIF_TYPED_VALUE F28_553(EIF_REFERENCE);
extern EIF_TYPED_VALUE F28_554(EIF_REFERENCE);
extern EIF_TYPED_VALUE F28_555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F28_556(EIF_REFERENCE);
extern EIF_TYPED_VALUE F28_557(EIF_REFERENCE);
extern EIF_TYPED_VALUE F28_558(EIF_REFERENCE);
...
EIF_TYPED_VALUE F28_551 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F28_551,646,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F28_552)
EIF_TYPED_VALUE F28_552 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 27, Current, 0, 0, 646);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(27, Current, 646);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {387,0xFF01,303,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F28_553)
EIF_TYPED_VALUE F28_553 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 27, Current, 0, 0, 647);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(27, Current, 647);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000185, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 27, Current, 0, 0, 648);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(27, Current, 648);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000185, 0,0); /* Result */
...
RTOID (F28_555)
EIF_TYPED_VALUE F28_555 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 27, Current, 0, 0, 649);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(27, Current, 649);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000185, 0,0); /* Result */
...
EIF_TYPED_VALUE F28_556 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F28_556,651,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F28_557 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F28_557,652,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F28_558 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F28_558,645,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
