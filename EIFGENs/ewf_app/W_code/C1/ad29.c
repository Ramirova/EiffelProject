...
extern EIF_TYPED_VALUE F29_559(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet();

extern EIF_TYPED_VALUE F29_560(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet6();
...
/* {ADDRINFO}.af_inet */
EIF_TYPED_VALUE F29_559 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 28, Current, 0, 0, 652);
	RTSA(Dtype(Current));
	RTSC;
...
/* {ADDRINFO}.af_inet6 */
EIF_TYPED_VALUE F29_560 (EIF_REFERENCE Current)
{
	GTCX
