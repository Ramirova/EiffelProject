...
extern EIF_TYPED_VALUE F75_1181(EIF_REFERENCE);
extern EIF_TYPED_VALUE F75_1182(EIF_REFERENCE);
extern EIF_TYPED_VALUE F75_1183(EIF_REFERENCE);
extern void F75_1184(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F75_1181 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 74, Current, 1, 0, 1212);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(74, Current, 1212);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1122, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F75_1182)
EIF_TYPED_VALUE F75_1182 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 74, Current, 0, 0, 1213);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(74, Current, 1213);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F75_1183)
EIF_TYPED_VALUE F75_1183 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 74, Current, 0, 0, 1214);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(74, Current, 1214);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800004C, 0,0); /* Result */
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {540,278,0xFFFF};
		EIF_TYPE typres0;
...
void F75_1184 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 74, Current, 0, 1, 1215);
	RTSA(Dtype(Current));
	RTSC;
