...
extern EIF_TYPED_VALUE F87_1349(EIF_REFERENCE);
extern EIF_TYPED_VALUE F87_1350(EIF_REFERENCE);
extern EIF_TYPED_VALUE F87_1351(EIF_REFERENCE);
...
EIF_TYPED_VALUE F87_1349 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F87_1350 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F87_1351 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 86, Current, 0, 0, 1356);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(86, Current, 1356);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(1220, "fractional_second", tr1));
