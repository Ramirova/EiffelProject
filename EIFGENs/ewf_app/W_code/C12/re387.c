...
extern EIF_TYPED_VALUE F387_4115(EIF_REFERENCE);
extern EIF_TYPED_VALUE F387_4118(EIF_REFERENCE);
extern void F387_7411(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F387_4115 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 386, Current, 0, 0, 5233);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 5233);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F387_4118 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 386, Current, 0, 0, 5234);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 5234);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F387_7411 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 386, Current, 0, 7410);
	RTSA(dtype);
	RTME(dtype, 0);
