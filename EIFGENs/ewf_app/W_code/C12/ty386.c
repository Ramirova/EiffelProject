...
extern EIF_TYPED_VALUE F386_3910(EIF_REFERENCE);
...
EIF_TYPED_VALUE F386_3910 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 385, Current, 0, 0, 4370);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(385, Current, 4370);
	RTIV(Current, RTAL);
