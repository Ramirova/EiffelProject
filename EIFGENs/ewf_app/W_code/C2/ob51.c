...
extern EIF_TYPED_VALUE F51_754(EIF_REFERENCE);
...
EIF_TYPED_VALUE F51_754 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 50, Current, 0, 0, 820);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(50, Current, 820);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80003A7, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,935,0xFF05,0,0xFFFF};
		EIF_TYPE typres0;
