...
extern EIF_TYPED_VALUE F542_4115(EIF_REFERENCE);
extern EIF_TYPED_VALUE F542_4118(EIF_REFERENCE);
extern void F542_7411(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F542_4115 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 541, Current, 0, 0, 5242);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(541, Current, 5242);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F542_4118 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 541, Current, 0, 0, 5243);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(541, Current, 5243);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F542_7411 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 541, Current, 0, 7410);
	RTSA(dtype);
	RTME(dtype, 0);
