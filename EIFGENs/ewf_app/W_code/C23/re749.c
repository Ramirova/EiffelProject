...
extern EIF_TYPED_VALUE F749_4115(EIF_REFERENCE);
extern EIF_TYPED_VALUE F749_4118(EIF_REFERENCE);
extern void F749_7411(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F749_4115 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 748, Current, 0, 0, 5251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(748, Current, 5251);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F749_4118 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 748, Current, 0, 0, 5252);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(748, Current, 5252);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F749_7411 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 748, Current, 0, 7410);
	RTSA(dtype);
	RTME(dtype, 0);
