...
extern EIF_TYPED_VALUE F736_2086(EIF_REFERENCE);
extern void F736_7385(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F736_2086 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 735, Current, 0, 0, 2365);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(735, Current, 2365);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F736_7385 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 735, Current, 0, 7384);
	RTSA(dtype);
	RTME(dtype, 0);
