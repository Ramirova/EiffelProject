...
extern EIF_TYPED_VALUE F123_1791(EIF_REFERENCE);
...
EIF_TYPED_VALUE F123_1790 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 122, Current, 0, 0, 1761);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(122, Current, 1761);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1080, 71))(Current)).it_i4);
...
RTOID (F123_1791)
EIF_TYPED_VALUE F123_1791 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 122, Current, 0, 0, 1762);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(122, Current, 1762);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
