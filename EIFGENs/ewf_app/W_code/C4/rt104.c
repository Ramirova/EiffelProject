...
extern void F104_1548(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F104_1549(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F104_1548 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 103, Current, 0, 1, 1528);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(103, Current, 1528);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F104_1549 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 103, Current, 0, 1, 1529);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(103, Current, 1529);
	RTCC(arg1, 103, l_feature_name, 1, eif_new_type(303, 0x01), 0x01);
	RTIV(Current, RTAL);
