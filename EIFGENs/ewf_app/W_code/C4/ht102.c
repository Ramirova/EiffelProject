...
extern EIF_TYPED_VALUE F102_1535(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F102_1536(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F102_1535 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 101, Current, 0, 1, 1515);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(101, Current, 1515);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F102_1536 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 101, Current, 0, 1, 1516);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(101, Current, 1516);
	RTIV(Current, RTAL);
	RTHOOK(1);
	switch (arg1) {
		case 100L:
