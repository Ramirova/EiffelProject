...
extern void F223_3784(EIF_REFERENCE);
extern EIF_TYPED_VALUE F223_3785(EIF_REFERENCE);
...
void F223_3784 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 222, Current, 2, 0, 4246);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(222, Current, 4246);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F223_3785)
EIF_TYPED_VALUE F223_3785 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 222, Current, 0, 0, 4247);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(222, Current, 4247);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
